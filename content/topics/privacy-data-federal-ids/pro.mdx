...
A new state would have a chance to set data-minimization, consent, audit, access, retention, and cybersecurity rules at the start instead of retrofitting old systems [2], [3], [4].
