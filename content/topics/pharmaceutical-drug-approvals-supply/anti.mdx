...
A product also needs labelling, warnings, adverse-event reporting, compliance monitoring, inspections, enforcement, and recall pathways [1], [2], [3], [4]. A transition that recognizes approvals but misses surveillance or enforcement is incomplete.
