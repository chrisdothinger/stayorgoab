...
**1. Two systems already exist.** Federal elections and Alberta provincial elections are governed by separate institutions and statutes [1], [2], [3], [4]. Independence would not simply “rename” one system into another.

**2. Transition incentives are dangerous.** Political actors who expect to compete in the first post-transition system may also be tempted to shape the rules. Even neutral choices about timing, boundaries, finance limits, and registration can look partisan.

**3. Rules need enforcement legitimacy.** Spending caps, donation limits, third-party advertising rules, candidate eligibility, recounts, penalties, and appeals require a trusted regulator and legal process. If enforcement is unclear, losing sides may reject the outcome.

**4. Current sources do not provide the bridge.** The source pack shows existing federal and Alberta rules, not a complete independence transition law. Until that bridge exists, confident claims about democratic renewal are premature.
