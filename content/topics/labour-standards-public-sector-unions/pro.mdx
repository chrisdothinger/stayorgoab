...
Alberta’s current employment-standards and labour-relations systems provide a usable platform for many workplaces [4], [5], [6], [7], [8]. Independence would not require inventing every workplace rule from scratch.
...
The existence of federal labour and public-service rules [1], [2], [3] does not prove Alberta could not replace or recognize them. It does mean the plan has to identify affected workers and employers before independence day.
