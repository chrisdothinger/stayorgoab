...
Alberta could keep municipal police services where they exist, build provincial units for some specialist or rural functions, negotiate RCMP support for a transition period, and use provincial law to define oversight and accountability [1], [3], [5]. That model would still need contracts, budgets, labour terms, training, information systems, and public reporting.
