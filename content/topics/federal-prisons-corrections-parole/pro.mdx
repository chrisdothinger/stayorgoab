...
The federal baseline is visible: CSC, the Parole Board of Canada, and the CCRA structure federal custody, conditional release, supervision, and related administration [1], [2], [3]. Because the current system is legally defined, a future Alberta could identify each function and create successor authority instead of improvising.

### 3. Orderly transfer or service agreements are possible in principle

A pro-independence plan could negotiate whether Canada temporarily continues running federal facilities in Alberta, whether Alberta assumes institutions and staff, whether some inmates are moved, and how warrants, files, victims services, health records, and supervision responsibilities transfer [1], [2], [5].
