...
Alberta referendum law can structure a provincial vote, but it cannot make Canada negotiate, amend the Constitution, or recognize independence by itself [1], [3], [5], [6].
...
Amendment rules, other provinces, Indigenous and treaty rights, debts, assets, borders, citizenship, and recognition would have to be addressed before any lawful exit [2], [3], [11].
