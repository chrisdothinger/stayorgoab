...
Bill C-20 records show the Act was Parliament's response to the Secession Reference [7], [8], [9]. Pro-independence advocates can argue that means the Act should be read as a clarity trigger for negotiations, not as a blank cheque to erase a clear mandate.
